  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div className={`absolute inset-0 sm:top-[160] top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5 mb-6`}>
        {/* gradient part purple rounded starightline */}
        <div className={`flex flex-col justify-center items-center mt-5`}>
          <div className='w-5 h-5 rounded-full bg-[#8533ff]'></div>
          <div className='w-1 sm:h-80 h-40 	violet-gradient'></div>
        </div>

        {/* heroheading name and work section */}
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className={`text-[#00cc00]`}>Ifan</span>
          </h1>
